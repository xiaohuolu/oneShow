...
export default {
  ...
  methods: {
    ...
    getProtect(){
      this.utils.ajax(this, '/app/WinningEntries', this.data, false).then((res) => {
        this.items = res.data.winningentries
    ...
    getimgList(){
      this.utils.ajax(this,'/app/WEImage',{id:this.imgId},false).then((res)=>{
